    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>eBay产品管理</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            <el-table v-loading="table_loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading" element-loading-background="rgba(0, 0, 0, 0.8)" :data="data" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="origin_url" label="来源URL" width="140">
                    <template slot-scope="scope">
                ...
                <!-- <el-table-column prop="desc_url" label="描述URL">
                    <template slot-scope="scope">
...
//                  this.url = '/ms/table/list';
                ...
                this.$axios.get( '/ebay_products/check_index?page='+this.cur_page + '&user_id=' +this.user_id_filter + '&category_id=' + category_id_temp + '&supplier_id=' + this.supplier_id_filter + '&date_begin=' + date_begin_temp +'&date_end=' + date_end_temp + '&sku=' + this.filter_sku  + '&operate_user_id=' + this.operate_user_id + '&page_size=' + this.pagesize + '&status=' + this.statusSelect + '&name=' + this.filter_name
                ).then((res) => {
            ...
            saveCheck(pass) {
                ...
                this.$axios.post('/ebay_products/check', params).then((res) => {
                    if(res.data.code == 200) {
